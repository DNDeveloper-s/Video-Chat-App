...
/**
 * @returns {Element} videoEl
 * @param {Object} options 
 */

const roomSettings = require('./roomSettings');

 function createNewUserVideoEl(options = {
    peerId: String
}) {
    const videoContainer = document.querySelector('.video_container');
    const htmlToAdd = `
        <div class="video_holder">
            <video class="peersVideo" data-peerid="${options.peerId}" autoplay="autoplay"></video>
            ...
            <div class="actions">
                <div class="video_btn">
                    <div class="svg_container" data-btn="toggle_video">
                        <!-- Camera Off SVG -->
                        <?xml version="1.0" encoding="utf-8"?>
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" xml:space="preserve">
                            <metadata> Svg Vector Icons : http://www.onlinewebfonts.com/icon </metadata>
                ...
                <div class="mic_btn">
                    <div class="svg_container" data-btn="toggle_audio">
                        <!-- Microphone Off SVG -->
    ...
    return document.querySelector(`.video_holder > video[data-peerid="${options.peerId}"]`);
}


module.exports = {
    createNewUserVideoEl
}